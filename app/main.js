...
mainApp.config(function($stateProvider, $locationProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('root.records', {
            url: 'records?dgvPublication&metadataType&keyword&organization&type&representationType&opendata&availability&distributionFormat&catalog&q&offset',
        ...
        .state('root.service.records', {
            url: '/records?dgvPublication&metadataType&keyword&organization&type&representationType&opendata&availability&distributionFormat&q&offset',
            templateUrl: '/partials/records/list.html',
            controller: 'ServiceRecords',
            reloadOnSearch: false,
            params: {
